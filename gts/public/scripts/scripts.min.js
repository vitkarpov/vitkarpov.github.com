...
$(document).ready(function(){$(".js-promo-slider").unslider({dots:!1,arrows:!0,delay:5e3,fluid:!0,loop:!1,autoplay:!1})});
!function(t,e){var i=function(){function i(e,i){"dot"==e?(i='<ol class="dots">',t.each(n.li,function(t){i+='<li class="'+(t===n.i?e+" active":e)+'">'+ ++t+"</li>"}),i+="</ol>"):(i='<div class="',i=i+e+'s">'+i+e+' prev disabled">'+n.o.prev+"</div>"+i+e+' next">'+n.o.next+"</div></div>"),n.el.addClass("has-"+e+"s").append(i).find("."+e).click(function(){var e=t(this);e.hasClass("dot")?n.stop().to(e.index()):e.hasClass("prev")?n.prev():n.next()})}var n=this;n.o={speed:500,delay:3e3,init:0,pause:!e,loop:!e,keys:e,dots:e,arrows:e,prev:"&larr;",next:"&rarr;",fluid:e,starting:e,complete:e,items:">ul",item:">li",easing:"swing",autoplay:!0},n.init=function(e,s){n.o=t.extend(n.o,s),n.el=e,n.ul=e.find(n.o.items),n.max=[0|e.outerWidth(),0|e.outerHeight()],n.li=n.ul.find(n.o.item).each(function(e){var i=t(this),s=i.outerWidth(),o=i.outerHeight();s>n.max[0]&&(n.max[0]=s),o>n.max[1]&&(n.max[1]=o)});var s=n.o,o=n.ul,a=n.li,l=a.length;return n.i=0,e.css({width:n.max[0],height:a.first().outerHeight(),overflow:"hidden"}),o.css({position:"relative",left:0,width:100*l+"%"}),a.css(s.fluid?{"float":"left",width:100/l+"%"}:{"float":"left",width:n.max[0]+"px"}),s.autoplay&&setTimeout(function(){0|s.delay&&(n.play(),s.pause&&e.on("mouseover mouseout",function(t){n.stop(),"mouseout"===t.type&&n.play()}))},0|s.init),s.keys&&t(document).keydown(function(t){switch(t.which){case 37:n.prev();break;case 39:n.next();break;case 27:n.stop()}}),s.dots&&i("dot"),s.arrows&&i("arrow"),s.fluid&&t(window).resize(function(){n.r&&clearTimeout(n.r),n.r=setTimeout(function(){var t={height:a.eq(n.i).outerHeight()},i=e.outerWidth();o.css(t),t.width=Math.min(Math.round(i/e.parent().width()*100),100)+"%",e.css(t),a.css({width:i+"px"})},50)}).resize(),(t.event.special.move||t.Event("move"))&&e.on("movestart",function(t){t.distX>t.distY&&t.distX<-t.distY||t.distX<t.distY&&t.distX>-t.distY?t.preventDefault():e.data("left",n.ul.offset().left/e.width()*100)}).on("move",function(t){var i=100*t.distX/e.width(),s=100*t.deltaX/e.width();n.ul[0].style.left=parseInt(n.ul[0].style.left.replace("%",""))+s+"%",n.ul.data("left",i)}).on("moveend",function(t){var e=n.ul.data("left");if(Math.abs(e)>30){var i=e>0?n.i-1:n.i+1;(0>i||i>=l)&&(i=n.i),n.to(i)}else n.to(n.i)}),n},n.to=function(i,s){n.t&&(n.stop(),n.play());var o=n.o,a=n.el,l=n.ul,r=n.li,d=n.i,u=r.eq(i);t.isFunction(o.starting)&&!s&&o.starting(a,r.eq(d));var c=i>=r.length-1,f=0>=i,h=a.find(".arrow");if(h.removeClass("disabled"),f?h.filter(".prev").addClass("disabled"):c&&h.filter(".next").addClass("disabled"),u.length&&!(0>i)||o.loop!==e){u.length||(i=0),0>i&&(i=r.length-1),u=r.eq(i);var v=s?5:0|o.speed,p=o.easing,m={height:u.outerHeight()};l.queue("fx").length||(a.find(".dot").eq(i).addClass("active").siblings().removeClass("active"),a.animate(m,v,p)&&l.animate(t.extend({left:"-"+i+"00%"},m),v,p,function(e){n.i=i,t.isFunction(o.complete)&&!s&&o.complete(a,u)}))}},n.play=function(){n.t=setInterval(function(){n.to(n.i+1)},0|n.o.delay)},n.stop=function(){return n.t=clearInterval(n.t),n},n.next=function(){return n.stop().to(n.i+1)},n.prev=function(){return n.stop().to(n.i-1)}};t.fn.unslider=function(e){var n=this.length;return this.each(function(s){var o=t(this),a="unslider"+(n>1?"-"+ ++s:""),l=(new i).init(o,e);o.data(a,l).data("key",a)})},i.version="1.0.0"}(jQuery,!1);
